...
class AjaxMapping
{
    ...
    public function __Construct()
    {
        ...
        $this->tableNameAttributeGroups = $this->tableViewNameGenerator->getViewName(SoluteConfig::UM_TABLE_ATTRIBUTE_GROUPS);
    }
    ...
    {
        $tableNameAttributeSchema = $this->tableViewNameGenerator->getViewName(SoluteConfig::UM_TABLE_ATTRIBUTE_SCHEMA);
        ...
        foreach ($result as $key => $row) {
            if ($row[SoluteConfig::UM_COL_VALID_VALUES] !== '[]') {
                $result[$key][SoluteConfig::UM_COL_VALID_VALUES] = json_decode($row[SoluteConfig::UM_COL_VALID_VALUES], true);
            } else {
