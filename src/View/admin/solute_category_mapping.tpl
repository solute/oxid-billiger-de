...
<html lang="de">
    ...
    <body>
        ...
        <h1>[{oxmultilang ident="UMSOLUTE_TITLE_CATEGORY_MAPPING"}]</h1>
        <form method="post" action="[{$oView->getActionUrl()}]">
            ...
            <input type="hidden" name="soluteCategoryId"    id="categoryId" value="[{$oView->getSoluteCategoryId()}]" />
            <input type="hidden" name="oxid"                                value="[{$oView->getSoluteCategoryId()}]" />
            <input type="hidden" name="saveMapping"                         value="1" />
            <input type="hidden" name="cl"                                  value="CategoryMappingController" />
    ...
    <script src="[{$moduleUrl}]out/src/js/ajaxCategoryMapping.js"></script>
</html>