...
$aModule = [
    ...
    'thumbnail'   => 'out/src/admin/billiger_Logo_schwarz.jpg',
    'version'     => '1.0.0',
    'author'      => 'Unit M GmbH',
    ...
    'templates'   => [
        'solute_article_list.tpl'           => 'unitm/oxid_solute/src/View/admin/solute_article_list.tpl',
        'solute_shop_mapping.tpl'           => 'unitm/oxid_solute/src/View/admin/solute_shop_mapping.tpl',
        'solute_article_mapping.tpl'        => 'unitm/oxid_solute/src/View/admin/solute_article_mapping.tpl',
        'solute_category_mapping.tpl'       => 'unitm/oxid_solute/src/View/admin/solute_category_mapping.tpl',
        'solute_field_definition_list.tpl'  => 'unitm/oxid_solute/src/View/admin/solute_field_definition_list.tpl',
    ],
    'settings' => [
        [
